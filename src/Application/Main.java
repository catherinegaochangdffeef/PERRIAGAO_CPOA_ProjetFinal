...
public class Main {
	public static void main(String[] args) {
		...
		System.out.println("Passer de MySQL � ListeMemoire?  1:yes 2:no");
		...
		System.out.println("1:Cat�gorie 2: Produit 3: Client 4: Commande 5: Ligne de commande");
		...
		if (partie==1) {
			...
			if(p==1) {
				...
				try {
					...
					System.out.println("cette cat�gorie n'existe pas!");
					e.printStackTrace();
				}
